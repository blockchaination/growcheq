        ...
        <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-4 w-full md:w-auto">
            <Button
              ...
              size="lg"
              onClick={onCtaClick}
              className="group px-8 py-4 h-auto text-lg font-bold shadow-2xl hover:shadow-[0_20px_50px_rgba(47,25,109,0.4)] hover:scale-105 transition-all duration-300 w-full md:w-auto"
            >
              Start Free Trial
